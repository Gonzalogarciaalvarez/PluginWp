...
función  insertar () {
    ...
    $ dbTable -> insert ( $ nombre_tabla , matriz  ( "palabramalsonante" => "Bitch" ));
    $ dbTable -> insert ( $ nombre_tabla , matriz ( "palabramalsonante" => "Motherfucker" ));
    $ dbTable -> insert ( $ nombre_tabla , matriz  ( "palabramalsonante" => "Cunt" ));
    $ dbTable -> insert ( $ nombre_tabla , matriz ( "palabramalsonante" => "Nigger" ));
}
